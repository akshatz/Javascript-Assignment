...
//filterByIsPublic
function isPublic(){
  var radio = document.getElementById("isPublic").value;
  var  filterByIsPublic =todo_array.filter(function(isPublic)){
    return (isPublic.checked === true){

    }
  }
  display_element(filterByIsPublic);
